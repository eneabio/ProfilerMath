...
int main(int argc, const char * argv[])
{
	...
	row0 = Vec4f(Randomf(range), Randomf(range), Randomf(range), Randomf(range));
	row1 = Vec4f(Randomf(range), Randomf(range), Randomf(range), Randomf(range));
	row2 = Vec4f(Randomf(range), Randomf(range), Randomf(range), Randomf(range));
	row3 = Vec4f(Randomf(range), Randomf(range), Randomf(range), Randomf(range));
	Mat44f r = Mat44f(row0, row1, row2, row3);
	Mat44f outMat;
	Clock start = Start();
	Mat44fInvert(l, &outMat);
	//Mat44fCoFactor(l, 1, 1);
	Clock stop = Stop();
